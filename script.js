...
//for fetching meal data fro the given serch term and making HTML template for the data
async function showMealList() {
    const list = JSON.parse(localStorage.getItem(dbObjectFavList));
    const inputValue = document.getElementById("search-input").value;
    const url = "https://www.themealdb.com/api/json/v1/1/search.php?s=";
    //calling the above mentioned project to get data from API
...
//adding to(or removing from) Fav list
...
//displaying details for the specific meal
...
//displaying list of meals in the favourite list
